...
public class MedicineCheckoutCart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine_checkout_cart);
        ...
        Database db=new Database(MedicineCheckoutCart.this,"healthcare",null,1);
        ArrayList data=db.getCardData(username,"medicine");
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MedicineCheckoutCart.super.onBackPressed();
            }
        });
