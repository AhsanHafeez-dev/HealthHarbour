    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CartBuyMedicine.super.onBackPressed();
            }
        });
        ...
        btnpurchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Database db=new Database(CartBuyMedicine.this,"healthcare",null,1);

                if(db.checkCart(username,product)==1)
                {
                    Toast.makeText(CartBuyMedicine.this, "Product Already Added", Toast.LENGTH_SHORT).show();
                }
                else
                {

                    db.AddToCart(username,product,price,"medicine");
                    Toast.makeText(CartBuyMedicine.this, "Succesfully added to cart", Toast.LENGTH_SHORT).show();
